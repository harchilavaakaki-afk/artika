...
const FALLBACK: ScheduleItem[] = [
  { time: "09:00", name: "Йога для начинающих", trainer: "Наталия Жарикова", hall: "Средний зал" },
  { time: "10:00", name: "Функциональная тренировка", trainer: "Екатерина Лазарева", hall: "Большой зал" },
  { time: "11:00", name: "Стретчинг", trainer: "Елена Шарикова", hall: "Средний зал" },
  { time: "17:00", name: "Сила+", trainer: "Александр Флотский", hall: "Большой зал" },
  { time: "18:00", name: "Пилатес", trainer: "Елена Шарикова", hall: "Средний зал" },
];
