...
export const metadata: Metadata = {
  title: "Цены и абонементы — Фитнес-студия Арктика, Видное",
  description:
    "Абонементы фитнес-студии Арктика в Видном: дневные и безлимитные карты, разовое посещение. Узнайте цены и запишитесь.",
  alternates: { canonical: `${SITE.url}/pricing` },
  openGraph: {
    title: "Цены и абонементы — Фитнес-студия Арктика, Видное",
    description:
      "Дневные и безлимитные карты. Запишитесь на пробное занятие в Арктику.",
...
const faq = [
  ...
  },
  {
    ...
    a: "Да! Вы можете прийти на пробное групповое занятие. Оставьте заявку или позвоните для записи.",
  },
  {
