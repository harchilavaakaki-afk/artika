...
export const metadata: Metadata = {
  title: "Зоны клуба — Фитнес-студия Арктика, Видное",
  description:
    "Тренажёрный зал, кардиозона, залы для групповых занятий, вело-зал. Современное оборудование в фитнес-студии Арктика, Видное.",
  alternates: { canonical: `${SITE.url}/facilities` },
  openGraph: {
    title: "Зоны клуба — Фитнес-студия Арктика, Видное",
    description:
      "6 зон для тренировок: тренажёрный зал, кардио, групповые залы, вело-зал.",
