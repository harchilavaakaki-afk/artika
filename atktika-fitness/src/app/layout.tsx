...
export const metadata: Metadata = {
  title: {
    template: "%s | Фитнес-клуб Арктика, Видное",
    default:
      "Фитнес-клуб Арктика в Видном — тренажёрный зал, йога, пилатес, 20+ направлений",
  },
  description:
    "Фитнес-клуб Арктика в Видном (Зелёный пер., 10): тренажёрный зал, групповые занятия — йога, пилатес, стретчинг, функциональный тренинг. 20+ направлений, 9 тренеров. Запишитесь на пробное.",
  metadataBase: new URL("https://arcfit.ru"),
  openGraph: {
    type: "website",
    locale: "ru_RU",
    url: "https://arcfit.ru",
    siteName: "Фитнес-клуб Арктика",
    title: "Фитнес-клуб Арктика в Видном — тренажёрный зал, йога, пилатес",
    description:
      "Фитнес-клуб в Видном, Зелёный пер., 10. 20+ групповых направлений и тренажёрный зал. Запись на пробное занятие.",
