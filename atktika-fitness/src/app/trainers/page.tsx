...
export const metadata: Metadata = {
  title: "Наши тренеры — Фитнес-студия Арктика, Видное",
  description:
    "9 профессиональных тренеров фитнес-студии Арктика в Видном. Инструкторы по йоге, пилатесу, силовым и групповым программам. Персональные тренировки.",
  openGraph: {
    title: "Наши тренеры — Арктика Фитнес",
    description:
      "Профессиональные тренеры фитнес-студии Арктика в Видном.",
